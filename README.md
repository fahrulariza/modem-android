...
### Cara Kerja / Perintah pada Module
 1. Module akan mengecek apakah terpasang simcard operator pada `simcard1`. jika ada tidak simcard maka tahan monitoring sampai ada simcard. jika simcard1 terdeteksi maka lanjutkan ke perintah no 2.
